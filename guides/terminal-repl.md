...
<div style="width: 100%; max-width: 100%; margin: 24px 0;">
  <img src="{{ site.baseurl }}/assets/images/screenshot.png" alt="Zorora Terminal REPL" style="width: 100%; max-width: 100%; height: auto; border-radius: 4px; border: 1px solid var(--border-grey); display: block;">
</div>
